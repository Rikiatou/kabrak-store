      ...
      <section className="py-14 sm:py-20 px-5 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-5 sm:gap-6">
            {(fr ? [
              { name: 'KABRAK STORE', priceMonth: '4 900', tag: 'Boutique · Vente en ligne · Commandes', users: '1 utilisateur', features: ['Ventes & commandes', 'Produits & catalogue', 'Caisse POS simple', 'Clients & historique', 'Acomptes & paiements', 'Factures WhatsApp incluses', 'Dashboard & stats', '💰 Dépenses & Bénéfice net', '📊 Rapports basiques', '🎨 Logo & couleur facture'], color: 'border-gray-200', btn: 'border-2 border-blue-200 text-blue-600 hover:bg-blue-50' },
              { name: 'KABRAK SHOP', priceMonth: '7 900', tag: 'Commerce général · Services · Boutique+', users: '3 utilisateurs', features: ['Tout STORE +', 'Catégories & organisation', 'Livraisons & suivi', 'Programme fidélité', 'Employés & permissions', 'Stock avancé & scanner', 'Export CSV', 'Rapports avancés', '🏪 Fournisseurs'], popular: true, color: 'border-blue-400 ring-2 ring-blue-200', btn: 'bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:opacity-90 shadow-lg shadow-blue-200' },
              ...
              { name: 'KABRAK STORE', priceMonth: '4 900', tag: 'Retail · Online selling · Orders', users: '1 user', features: ['Sales & orders', 'Products & catalog', 'Simple POS register', 'Clients & history', 'Deposits & payments', 'WhatsApp invoices included', 'Dashboard & stats', '💰 Expenses & Net Profit', '📊 Basic reports', '🎨 Logo & invoice color'], color: 'border-gray-200', btn: 'border-2 border-blue-200 text-blue-600 hover:bg-blue-50' },
              { name: 'KABRAK SHOP', priceMonth: '7 900', tag: 'General store · Services · Growing biz', users: '3 users', features: ['Everything in STORE +', 'Categories & organization', 'Deliveries & tracking', 'Loyalty program', 'Employees & roles', 'Advanced stock & scanner', 'CSV Export', 'Advanced reports', '🏪 Suppliers'], popular: true, color: 'border-blue-400 ring-2 ring-blue-200', btn: 'bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:opacity-90 shadow-lg shadow-blue-200' },
